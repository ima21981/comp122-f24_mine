...
## Tuesday's Lab
  ...
  * Binary String: 101011111101110001110001100110101010111 (given)
    - 8# 5 375 616 146 527  <!-- response -->
      - 101 011 111 101 110 001 110 001 100 110 101 010 111
      - 5   3   7   5   6   1   6   1   4   6   5   2   7

    - 16# 00AF DC71 9AAE
      - 1010 1111 1101 1100 0111 0001 1001 1010 1010 1110 (padded)
      - A    F    D    C    7    1    9    A    A    E

    - BCD: - --- 719 --- 
      - 1010 1111 1101 1100 0111 0001 1001 1010 1010 1110 (padded)
      - -    -    -    -    7    1    9    -    -    - 
      - 101011111101110001110001100110101010111

  * Binary Number: 101011111101110001110001100110101010111 (given)
    - 8# 5 375 616 146 527
      - 101 011 111 101 110 001 110 001 100 110 101 010 111
      - 5   3   7   5   6   1   6   1   4   6   5   2   7
   ...
   * Base 8 -> 2
     - 8# 12 335 475 524 624 274 654
       - 12        335           475           524
       - 001 010 | 011 011 101 | 100 111 101 | 101 010 100 | 
   * Base 16 -> 2
     - 16# 25e7 56ad 
     - 25e7                  56ad 
     - 0010 0101 1110 0111 | 0101 0110 1010 1101
  
  * Base 16 -> Base 8
    - 16# 25e7 56ad 
    - 0010 0101 1110 0111 | 0101 0110 1010 1101
    - "0"00 100 101 111 001 110 101 011 010 101 101
    - 0     4   5   7   1   6   5   3   2   5   5
    - 8# 04 571 653 255

  * ASCII -> binary
    - !la\*s2c
    - 16#       21         6c        61 5c        42 73 32 63
    -    0010 0001  0110 1100 0110 0001 0110 1100
  ...
  * Binary String --> base64
    ...
    - 10 1010 | 11 1011  | 11 1001 | 11 0011 |  10 101"0"
    - q
