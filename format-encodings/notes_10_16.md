...
# Today's Lecture Material
  ...
  1. Review of Floating Point
     ...
     * Encode `1.01011010101 x 2^101` to binary32
       * Identify the parts to encode
         * sign of the number  | '+'            | 
     ...
     - starter code:
       * format_encodings/encode_binary32.j
         1. Encode each of the three fields of the floating point format:
            - Sign Encoding: (encoded_sign = )
            - Exponent Encoding: (encoded_expon = )
            - Mantissa Encoding: (encoded_mantissa = )
