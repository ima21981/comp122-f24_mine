...
subroutine:     .asciiz "toUpper"
                # toUpper("He^&%^#@llo woffrld 34")"
...
argv:           .word arg_0 
                 ...
                 .align 0
arg_0:          .asciiz "He^&%^#@llo woffrld 34"
...
skip2:          nop
  ...
  main:         nop      
                nop # "toUpper" must to restore stack to here
                sw $sp, saved_sp

                nop # Marshal the input arguments into the registers
                la $a0, arg_0                # "He^&%^#@llo woffrld 34"
